...
app = FastAPI(
    title="Hackathon Idea API — AI 연결 전",
    description="3회차 시작 템플릿: 지난 시간에 완성한 SQLite CRUD입니다.",
    version="3.0.0",
)
...
def root() -> dict[str, str]:
    return {"message": "아이디어 CRUD가 준비되었습니다. 오늘 AI 분석을 추가합니다."}
...
# 3회차 실습에서 이어서 만들 기능
# POST /ideas/{idea_id}/analyze   : AI 분석 생성 또는 기존 결과 재사용
# GET  /ideas/{idea_id}/analysis : 저장된 AI 분석 조회
